          ...
          <Tabs defaultValue="betting">
            ...
            <TabsContent value="betting">
              {data.betting ? (
                ...
                <div className="py-8 text-center text-muted-foreground">No betting data available</div>
              )}
            </TabsContent>
            ...
            <TabsContent value="savings">
              {data.savings ? (
                ...
                <div className="py-8 text-center text-muted-foreground">No savings data available</div>
              )}
            </TabsContent>
